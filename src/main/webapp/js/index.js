        ...
        loadMenu: function () {
            var data = [{
...

                {
                    ...
                    "F_FullName": "民意统计",
                    "F_Icon": "fa fa-sitemap",
                    "F_UrlAddress": "handleStatic.html",
                    "F_Target": "iframe",
                    "F_IsMenu": 1,
                    "F_AllowExpand": 1,
                    "F_IsPublic": 0,
                ...
                },
                {
                    ...
                    "F_FullName": "异议建议",
                    "F_Icon": "fa fa-sitemap",
                    "F_UrlAddress": "recode_dissent.html",
                    "F_Target": "iframe",
                    "F_IsMenu": 1,
                    "F_AllowExpand": 1,
                    "F_IsPublic": 0,
            ...
            $.each(data, function (i) {
                var row = data[i];
                var enCode = job == '管理员'?'SysManage':'OrganizeManage';
                if (row.F_EnCode != enCode) {
                    // jQuery的each循环中break用"return false;"，continue用"return true;"实现
                    return true;
                }
                if (row.F_ParentId == "0") {
                    if (i == 0) {
